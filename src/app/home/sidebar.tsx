export default function SideBar() {
  return (
    <main className="border-r-2 flex">
      <div className="ml-2 flex w-16 flex-col items-center space-y-7 py-6">
        <div className="flex items-center justify-center rounded-md p-1 text-blue-600">
          <svg
